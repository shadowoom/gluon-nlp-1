...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "All Logs will be saved to transformer_en_de_u512/<ipython-input-2-a59c28fb08ac>.log\n"
 },
 {
  "data": {
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Load cached data from /home/ubuntu/cgwang/code/gluon-nlp-1/docs/examples/nmt/nmt/cached/TOY_en_de_-1_-1_train.npz\nLoad cached data from /home/ubuntu/cgwang/code/gluon-nlp-1/docs/examples/nmt/nmt/cached/TOY_en_de_-1_-1_val.npz\nLoad cached data from /home/ubuntu/cgwang/code/gluon-nlp-1/docs/examples/nmt/nmt/cached/TOY_en_de_-1_-1_False_test.npz\n"
 }
]
```
...
[
 {
  "name": "stderr",
  "output_type": "stream",
  "text": "2018-08-19 06:23:39,661 - root - Use beam_size=4, alpha=0.6, K=5\n"
 }
]
```
...
[
 {
  "name": "stderr",
  "output_type": "stream",
  "text": "2018-08-19 06:23:42,819 - root - [Epoch 0 Batch 10/14] loss=28.9083, ppl=3586784548312.6875, throughput=0.37K wps, wc=1.09K\n2018-08-19 06:24:55,273 - root - [Epoch 0] valid Loss=15.2710, valid ppl=4286389.2761, valid bleu=0.00\n2018-08-19 06:26:02,507 - root - [Epoch 0] test Loss=15.2710, test ppl=4286389.2761, test bleu=0.00\n2018-08-19 06:26:04,889 - root - [Epoch 1 Batch 10/14] loss=26.3085, ppl=266466934383.6738, throughput=0.64K wps, wc=1.15K\n2018-08-19 06:27:12,643 - root - [Epoch 1] valid Loss=11.3263, valid ppl=82971.9571, valid bleu=0.00\n2018-08-19 06:28:19,737 - root - [Epoch 1] test Loss=11.3263, test ppl=82971.9571, test bleu=0.00\n2018-08-19 06:28:22,199 - root - [Epoch 2 Batch 10/14] loss=11.7460, ppl=126243.8681, throughput=0.71K wps, wc=1.32K\n2018-08-19 06:29:31,739 - root - [Epoch 2] valid Loss=6.7492, valid ppl=853.3337, valid bleu=0.00\n2018-08-19 06:30:39,530 - root - [Epoch 2] test Loss=6.7492, test ppl=853.3337, test bleu=0.00\n2018-08-19 06:31:49,649 - root - Best model valid Loss=8.7832, valid ppl=6523.6766, valid bleu=0.00\n2018-08-19 06:32:58,397 - root - Best model test Loss=8.7832, test ppl=6523.6766, test bleu=0.00\n"
 }
]
```
...
```{.python .input  n=12}
translator = nmt.translation.BeamSearchTranslator(model=transformer_model, beam_size=hparams.beam_size,
                                  scorer=nlp.model.BeamSearchScorer(alpha=hparams.lp_alpha,
                                                          K=hparams.lp_k),
                                  max_length=200)
...
print('Pretrained model validation loss %.2f'%(valid_loss))
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Pretrained model validation loss 9.89\nPretrained model test loss 9.89\n"
 }
]
```
